...
class QuestionsListMvc(
    ...
    interface Listener {
        ...
        fun onQuestionsClicked(clickedQuestion: Question)
    }
    ...
    init {
        ...
        questionsAdapter = QuestionsListMvc.QuestionsAdapter { clickedQuestion ->
            for (listener in listeners) {
                listener.onQuestionsClicked(clickedQuestion)
            }
        }
